...
source("checkdata_prepare.R") # check how many raw datasets you have
...
if (run.raw) {
  primaryGVE <- read.csv(fileRaw1)
  
  if (raw.5datasets) primaryLeuven2011 <- read.csv(fileRaw2)
  if (raw.5datasets) primaryLeuven3W <- read.csv(fileRaw3)
  
  # Merging for Tilburg primary data
  primaryTilburg <- read_sav(fileRaw4)
  rawdemo <- read_sav(demoRaw4)
  ...
  if (raw.5datasets) primaryLeuven2011$NAT_BL <- ifelse(primaryLeuven2011$NAT_BL==1,1,0)
  if (raw.5datasets) primaryLeuven3W$NAT_BL <- ifelse(primaryLeuven3W$NAT_BL==1,1,0)
  ...
  if (raw.5datasets) primaryLeuven2011$UUID <- as.integer(factor(primaryLeuven2011$UUID))+2000
  if (raw.5datasets) primaryLeuven3W$UUID <- as.integer(factor(primaryLeuven3W$UUID))+3000
  ...
  if (raw.5datasets) primaryLeuven2011$AGE <- round(primaryLeuven2011$AGE_BL,0) 
  if (raw.5datasets) primaryLeuven3W$AGE <- round(primaryLeuven3W$AGE_BL,0)
  ...
  if (raw.5datasets) primaryLeuven2011$AGE_BL <- NULL
  if (raw.5datasets) primaryLeuven3W$AGE_BL <- NULL
  ...
  if (raw.5datasets) write.csv(primaryLeuven2011,"dataPrimary/primaryLeuven2011.csv", row.names = FALSE)
  if (raw.5datasets) write.csv(primaryLeuven3W,"dataPrimary/primaryLeuven3W.csv", row.names = FALSE)
...
if (primary.5datasets) dataLeuven2011 <- read.csv("dataPrimary/primaryLeuven2011.csv")
if (primary.5datasets) dataLeuven3W <- read.csv("dataPrimary/primaryLeuven3W.csv")
...
if (primary.5datasets) dataLeuven2011$PARTICIPANT_ID<-paste0("L11_",dataLeuven2011$PARTICIPANT_ID)
if (primary.5datasets) dataLeuven3W$PARTICIPANT_ID<-paste0("L3W_",dataLeuven3W$PARTICIPANT_ID)
...
if (primary.5datasets) dataLeuven2011$beepperday <- 10
if (primary.5datasets) dataLeuven3W$beepperday <- 10
...
if (primary.5datasets) dataLeuven2011$filledESM <- !is.na(dataLeuven2011$timeperquestion)
...
if (primary.5datasets) dataLeuven3W$filledESM <- (rowMeans(sapply(dataLeuven3W[,c(inputNA.Leuven3W,inputPA.Leuven3W,inputER.Leuven3W)], is.na))) < 1
...
# 2.3. Calculate all momentary dynamics indices
  ...
  if (primary.5datasets)   dataLeuven2011 <- calcDynamics(dataLeuven2011, inputNA.Leuven2011,inputER.Leuven2011,inputPA.Leuven2011)
  if (primary.5datasets)   dataLeuven3W <- calcDynamics(dataLeuven3W, inputNA.Leuven3W,inputER.Leuven3W,inputPA.Leuven3W)
...
if (primary.5datasets) write.csv(dataLeuven2011, "dataProcessed/ReadyLeuven2011.csv", row.names = FALSE)
if (primary.5datasets) write.csv(dataLeuven3W, "dataProcessed/ReadyLeuven3W.csv", row.names = FALSE)

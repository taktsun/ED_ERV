...
abstract: |
  ...
  Word count: Abstract: 150 words. Statement of relevance: 148 words. Introduction and Discussion: 1972 words. Methods and Results (excluding tables and figures): 2196 words. Tables and figures: 683 words.
  ...
  <!--Conflicts of interest: All authors declare no conflicts of interest. Funding: ANONYMIZED. Artificial intelligence: Artificial intelligence assisted technologies were used in the creation of this article for paraphrasing and grammatical checks. Ethics: This research complies with the Declaration of Helsinki (2023), aside from the requirement to preregister human subjects research, and received approval from local ethics boards (ID: ANONYMIZED). Computational reproducibility: Following the Workflow for Open Reproducible Code in Science [@vanlissaWORCSWorkflowOpen2021], the preregistration (hypotheses and analysis plan), primary data and analysis codes of this study are available via ANONYMIZED. The authors are applying for a Computational Reproducibility Badge which will be awarded pending checks by the STAR Team.-->

  ## Study One

  <!--NON-ANONYMIZED version-->
  
  Preregistration: The hypotheses and methods were preregistered (https://doi.org/10.17605/OSF.IO/9VX7T) on 2022-05-04 prior to accessing the five datasets used in this study. There was an update of preregistration on 2023-10-19 for the purpose of including more datasets to achieve sufficient power for our hypotheses (for details, see Supplementary Materials 1). Materials: All study materials are publicly available (https://doi.org/10.17605/OSF.IO/CQ6N4 and Supplemental Materials 2). Data: All primary data are publicly available (https://doi.org/10.17605/OSF.IO/CQ6N4). Analysis scripts: All analysis scripts are publicly available (https://github.com/taktsun/ED_ERV).

    <!--ANONYMIZED version-->
    
  <!--Preregistration: The hypotheses and methods were preregistered (ANONYMIZED) on 2022-05-04 prior to accessing the five datasets used in this study. There was an update of preregistration on 2023-10-19 for the purpose of including more datasets to achieve sufficient power for our hypotheses (for details, see Supplementary Materials 1). Materials: All study materials are publicly available (ANONYMIZED and Supplemental Materials 2). Data: All primary data are publicly available (ANONYMIZED). Analysis scripts: All analysis scripts are publicly available (ANONYMIZED).-->
...
On average, adolescents showed relatively low intensity of negative emotions and emotion regulation but high intensity of positive emotions (Table 2). With regards to dynamic indices (emotion differentiation and emotion regulation variability), within-person and between-person variance indicates that there is sufficient variation across time and between people. Within-person and between-person correlations between dynamic indices were generally weak (Supplemental Materials 4).

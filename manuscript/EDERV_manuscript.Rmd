...
This paper follows the Workflow for Open Reproducible Code in Science [@vanlissaWORCSWorkflowOpen2021]. The pre-registration (hypotheses and analysis plan), data and analysis codes of this study are available via https://doi.org/10.17605/OSF.IO/9VX7T. In Supplemental Materials 1, we detailed our _a priori_ power analysis which showed we had more than 80% power to test our hypotheses, and reported three minor deviations we had from our pre-registration.

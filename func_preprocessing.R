...
calcDynamics <- function(df, inputNA, inputER, inputPA){
  ...
  # calculate person and grand means and the between-person components of all variables
    ...
    df$person_PA.sd <- calc.fun(m_PA, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_NA.sd <- calc.fun(m_NA, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_ER.sd <- calc.fun(m_ER, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_ED.sd <- calc.fun(m_ED, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_EDPA.sd <- calc.fun(m_EDPA, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisFull.suc.sd <- calc.fun(BrayCurtisFull.suc, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisRepl.suc.sd <- calc.fun(BrayCurtisRepl.suc, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisNest.suc.sd <- calc.fun(BrayCurtisNest.suc, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisFull.amm.sd <- calc.fun(BrayCurtisFull.amm, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisRepl.amm.sd <- calc.fun(BrayCurtisRepl.amm, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisNest.amm.sd <- calc.fun(BrayCurtisNest.amm, PARTICIPANT_ID, data=df, FUN = sd, na.rm=TRUE, expand=TRUE)
    
    df$person_PA.skew <- calc.fun(m_PA, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_NA.skew <- calc.fun(m_NA, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_ER.skew <- calc.fun(m_ER, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_ED.skew <- calc.fun(m_ED, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_EDPA.skew <- calc.fun(m_EDPA, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisFull.suc.skew <- calc.fun(BrayCurtisFull.suc, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisRepl.suc.skew <- calc.fun(BrayCurtisRepl.suc, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisNest.suc.skew <- calc.fun(BrayCurtisNest.suc, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisFull.amm.skew <- calc.fun(BrayCurtisFull.amm, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisRepl.amm.skew <- calc.fun(BrayCurtisRepl.amm, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
    df$person_BrayCurtisNest.amm.skew <- calc.fun(BrayCurtisNest.amm, PARTICIPANT_ID, data=df, FUN = skewness, na.rm=TRUE, expand=TRUE)
